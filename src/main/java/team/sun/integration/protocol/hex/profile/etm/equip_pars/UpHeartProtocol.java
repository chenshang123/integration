...
@Component
@ProtocolCode(3060)
public class UpHeartProtocol extends HexConventHandlerAbstract {
    ...
    static {
        ...
        protocol.add(0, "4_code");//响应码 3060
    ...
    public String toJsonString(Map<String, Object> data) {
        return "{\"topic\":\"heartbeat/" + data.get("topic") + "\",\"payload\":\"{'lock':" + data.get("lock") + ",'door':" + data.get("door") + "}\",\"code\":" + data.get("code") + "}";
    }
