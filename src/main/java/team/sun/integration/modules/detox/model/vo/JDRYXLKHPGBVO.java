package team.sun.integration.modules.detox.model.vo;
 ...
 *戒毒人员员训练考核评估
 */
@ApiModel(value = "JDRYXLKHPGBVO", description = "戒毒人员员训练考核评估-详情")
public class JDRYXLKHPGBVO implements Serializable {
