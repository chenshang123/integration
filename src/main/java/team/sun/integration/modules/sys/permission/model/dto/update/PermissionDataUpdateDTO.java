package team.sun.integration.modules.sys.permission.model.dto.update;
...
@ApiModel(value = "PermissionDataUpdate对象", description = "系统-数据权限表-修改")
public class PermissionDataUpdateDTO implements Serializable {
