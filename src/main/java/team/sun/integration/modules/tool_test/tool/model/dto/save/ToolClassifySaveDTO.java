package team.sun.integration.modules.tool_test.tool.model.dto.save;
...
@ApiModel(value = "Classify-save", description = "保存-传参对象")
public class ToolClassifySaveDTO implements Serializable {
